...
var CreateClassModal = /** @class */ (function () {
    function CreateClassModal(groupName, groupCode, groupDescription, userId, userTypeId) {
    ...
    CreateClassModal.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String },
...
var StudentClassroomManagementGetDataModal = /** @class */ (function () {
    function StudentClassroomManagementGetDataModal(organizationId, groupId) {
        this.organization_id = organizationId;
        this.group_id = groupId;
    }
    StudentClassroomManagementGetDataModal.ctorParameters = function () { return [
        { type: String },
        { type: String }
    ]; };
    return StudentClassroomManagementGetDataModal;
}());
...
var ApiManagerService = /** @class */ (function () {
    ...
    ApiManagerService.prototype.sendBQueryPostRequest = function (topic, api, payload) {
        this.sendPostRequest(topic, api, RequestType.bQuery, payload);
    };
    ApiManagerService.prototype.sendBControllerPostRequest = function (topic, api, payload) {
        this.sendPostRequest(topic, api, RequestType.bController, payload);
    };
    ApiManagerService.prototype.sendPostRequest = function (topic, api, requestType, payload) {
        var _this = this;
        var finalApi;
        switch (requestType) {
        ...
        this.http
            ...
            _this.onCallbackReceived.next({
                topic: topic,
                data: transformedData
            });
        });
    };
    ApiManagerService.ctorParameters = function () { return [
...
var ChosenUsersService = /** @class */ (function () {
    function ChosenUsersService() {
        this.chosenUserIds = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]([]);
        this.currentList = this.chosenUserIds.asObservable();
    }
    ChosenUsersService.prototype.updateChosenUserList = function (updatedChosenUserList) {
        this.chosenUserIds.next(updatedChosenUserList);
    };
    ChosenUsersService.prototype.addToChosenUserList = function (UserId) {
        var updated = this.chosenUserIds.getValue();
        if (updated.indexOf(UserId) === -1) {
            updated.push(UserId);
        }
        this.updateChosenUserList(updated);
    };
    ChosenUsersService.prototype.removeFromChosenUserList = function (UserId) {
        var updated = this.chosenUserIds.getValue();
        var indexToRemove = updated.indexOf(UserId);
        delete updated[indexToRemove];
        this.updateChosenUserList(updated);
    };
    ChosenUsersService.prototype.clearSlate = function () {
        this.updateChosenUserList([]);
    };
    ChosenUsersService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
    ], ChosenUsersService);
    return ChosenUsersService;
}());
...
/* harmony import */ var ngx_editor__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ngx-editor */ "./node_modules/ngx-editor/fesm5/ngx-editor.js");
...
var ResetPasswordComponent = /** @class */ (function () {
    function ResetPasswordComponent(snackbar) {
        this.snackbar = snackbar;
        this.successfullyResetPassword = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ResetPasswordComponent.prototype.onResetPassword = function (password, confirmPassword) {
        var matches = this.passwordValidators(password, confirmPassword);
        if (matches) {
            this.successfullyResetPassword.emit();
            this.showSnackbarMessage('Success');
        }
    };
    ResetPasswordComponent.prototype.passwordValidators = function (password, confirmPassword) {
    ...
    ResetPasswordComponent.prototype.showSnackbarMessage = function (message) {
...
var AnswerElementComponent = /** @class */ (function () {
    function AnswerElementComponent(snackBar) {
        this.snackBar = snackBar;
    ...
    AnswerElementComponent.prototype.toggleUpvote = function () {
        if (this.upvoted) {
            this.upvoted = false;
            this.upvoteCount--;
        }
    ...
    AnswerElementComponent.prototype.showAnswerDiscussions = function () {
        this.showDiscussions = !this.showDiscussions;
    };
    AnswerElementComponent.prototype.toggleReply = function () {
    ...
    AnswerElementComponent.prototype.postDiscussionComment = function () {
        this.replying = false;
    ...
    AnswerElementComponent.prototype.getAnonymityScopeNameFromChosenAnonymityScopeId = function () {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.anonymityScope), _c = _b.next(); !_c.done; _c = _b.next()) {
                var anonymityScope = _c.value;
    ...
    AnswerElementComponent.prototype.onSelectionChangedAnonymityLevel = function ($event) {
    ...
    AnswerElementComponent.prototype.openSnackBar = function (message) {
        this.snackBar.open(message, 'Close', {
            duration: 2000,
        });
    };
    AnswerElementComponent.prototype.reportToggle = function () {
    ...
    AnswerElementComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var AnswerFeedComponent = /** @class */ (function () {
    function AnswerFeedComponent() {
    }
    AnswerFeedComponent.prototype.ngOnInit = function () {
        this.answerFeedOfPost = this.getAnswerFeedByPostId();
    };
    AnswerFeedComponent.prototype.getAnswerFeedByPostId = function () {
        // TODO: API CALL HERE ...
        var answerFeedOfPost = [
            {
                answerId: '1',
...
var DiscussionElementComponent = /** @class */ (function () {
    function DiscussionElementComponent() {
        ...
        this.author = 'Gopal Munapillai';
        this.dateTimePosted = '10 minutes ago';
    }
    DiscussionElementComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return DiscussionElementComponent;
}());
...
var DiscussionFeedComponent = /** @class */ (function () {
    function DiscussionFeedComponent() {
    }
    DiscussionFeedComponent.prototype.ngOnInit = function () {
        this.commentFeedOfAnswer = this.getDiscussionsByAnswerId();
    };
    DiscussionFeedComponent.prototype.getDiscussionsByAnswerId = function () {
        // TODO: API CALL HERE ...
        var discussionFeedOfAnswer = [
            {
    ...
    return DiscussionFeedComponent;
}());
...
module.exports = ".example-card {\r\n  max-width: 600px;\r\n}\r\n\r\n.example-header-image {\r\n  background-image: url('https://media-exp1.licdn.com/dms/image/C5103AQFqz72A7GA3JA/profile-displayphoto-shrink_200_200/0?e=1591833600&v=beta&t=UCTBRGwIUZD-q6NdcyOC05JUEzUnCtyP06mJG9Nu_2Q');\r\n  background-size: cover;\r\n}\r\n\r\n.make-inline { float:left; }\r\n\r\n.clearBoth { clear:both; }\r\n\r\n.report-button{\r\n  cursor: pointer;\r\n  text-decoration: underline;\r\n  font-size: small;\r\n  float: right;\r\n  margin-top: 10px;\r\n  margin-right: 10px;\r\n}\r\n\r\n.pre-report-button {\r\n\r\n}\r\n\r\n.post-report-button {\r\n  color: red;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var FeedElementComponent = /** @class */ (function () {
    function FeedElementComponent(snackBar) {
        this.snackBar = snackBar;
    ...
    FeedElementComponent.prototype.toggleUpvote = function () {
        if (this.upvoted) {
            this.upvoted = false;
            this.upvoteCount--;
        }
    ...
    FeedElementComponent.prototype.onPostEnter = function () {
        this.enterIntoPostWithPostId.emit(this.postId);
    };
    FeedElementComponent.prototype.reportToggle = function () {
        this.reported = !this.reported;
        if (this.reported) {
    ...
    // utility functions
    FeedElementComponent.prototype.snackBarCreator = function (message) {
        this.snackBar.open(message, 'Close', {
            duration: 1000,
        });
    };
    FeedElementComponent.prototype.hidePost = function () {
        this.snackBarCreator('Post Has been hidden');
    };
    FeedElementComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var FeedComponent = /** @class */ (function () {
    ...
    FeedComponent.prototype.onPostEnterListener = function (postId) {
        // Relaying
...
var CreateClassroomComponent = /** @class */ (function () {
    function CreateClassroomComponent(snackBar, apiManagerService) {
        this.snackBar = snackBar;
    ...
    CreateClassroomComponent_1 = CreateClassroomComponent;
    CreateClassroomComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.apiCallSubscription = this.apiManagerService.onCallbackReceived.subscribe(function (callback) {
            if (callback.topic === CreateClassroomComponent_1.name) {
                _this.onClassCreatedCallback(callback.data);
            }
        });
    };
    CreateClassroomComponent.prototype.createNewClass = function (classname, classId, classDescription) {
    ...
    CreateClassroomComponent.prototype.apiCall = function (className, classId, classDescription) {
        var api = this.apiManagerService.createClassroom;
        var createClassModal = new _Modals_CreateClassModal__WEBPACK_IMPORTED_MODULE_4__["CreateClassModal"](className, classId, classDescription, '123', '0');
        this.apiManagerService.sendBControllerPostRequest(CreateClassroomComponent_1.name, api, createClassModal);
    };
    CreateClassroomComponent.prototype.onClassCreatedCallback = function (callBackData) {
    ...
    CreateClassroomComponent.prototype.showSnackbarMessage = function (message) {
        this.snackBar.open(message, 'Close', {
            duration: 2000,
        });
    };
    var CreateClassroomComponent_1;
    CreateClassroomComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] },
...
var ManageClassroomInstructorsComponent = /** @class */ (function () {
    function ManageClassroomInstructorsComponent(chosenInstructors, snackBar) {
    ...
    ManageClassroomInstructorsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.categoryGroups = this.getInstructorCategories();
        this.chosenInstructors.currentList.subscribe(function (updatedChosenInstructorsList) {
            return _this.onInstructorChosenChanged(updatedChosenInstructorsList);
        });
        this.allInstructorNames = this.getAllInstructorNames();
        this.onInitUpdateExistingInstructorsToChosenInstructorsService();
    };
    ManageClassroomInstructorsComponent.prototype.onInstructorChosenChanged = function (updatedChosenInstructorList) {
        this.selectedInstructorIdsList = updatedChosenInstructorList;
    };
    ManageClassroomInstructorsComponent.prototype.selectCategory = function (categoryId) {
        var _this = this;
        this.currentCategoryId = categoryId;
        this.selectableInstructorList = this.getInstructorsByCategory(categoryId);
        this.categoryGroups.forEach(function (categoryGroup) {
            categoryGroup.category.forEach(function (singleCategory) {
                if (singleCategory.categoryId === categoryId) {
                    _this.categoryName = 'Showing ' + singleCategory.categoryName;
                    return;
                }
            });
        });
    };
    ManageClassroomInstructorsComponent.prototype.getInstructorCategories = function () {
        // TODO API CALL HERE
        var categoryGroups = [];
        categoryGroups[0] = {
            categoryGroupID: '1',
    ...
    ManageClassroomInstructorsComponent.prototype.getAllInstructorNames = function () {
        var e_1, _a;
        var allElements = [];
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.getInstructorsByCategory('-1')), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    ManageClassroomInstructorsComponent.prototype.getInstructorsByCategory = function (categoryId) {
    ...
    ManageClassroomInstructorsComponent.prototype.onInitUpdateExistingInstructorsToChosenInstructorsService = function () {
        var e_2, _a;
        // This means get all Instructors across all categories
        var allInstructors = this.getInstructorsByCategory('-1');
        try {
            for (var allInstructors_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](allInstructors), allInstructors_1_1 = allInstructors_1.next(); !allInstructors_1_1.done; allInstructors_1_1 = allInstructors_1.next()) {
                var Instructor = allInstructors_1_1.value;
            ...
            try {
                if (allInstructors_1_1 && !allInstructors_1_1.done && (_a = allInstructors_1.return)) _a.call(allInstructors_1);
            }
            finally { if (e_2) throw e_2.error; }
        }
    };
    ManageClassroomInstructorsComponent.prototype.selectAllInstructorsOfCurrentCategoryId = function () {
        var e_3, _a;
        var selectableInstructor = this.getInstructorsByCategory(this.currentCategoryId);
        if (selectableInstructor === undefined) {
            return;
        }
        try {
            for (var selectableInstructor_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](selectableInstructor), selectableInstructor_1_1 = selectableInstructor_1.next(); !selectableInstructor_1_1.done; selectableInstructor_1_1 = selectableInstructor_1.next()) {
                var element = selectableInstructor_1_1.value;
            ...
            try {
                if (selectableInstructor_1_1 && !selectableInstructor_1_1.done && (_a = selectableInstructor_1.return)) _a.call(selectableInstructor_1);
            }
            finally { if (e_3) throw e_3.error; }
        }
    };
    ManageClassroomInstructorsComponent.prototype.unselectInstructorsOfCurrentGroupId = function () {
        var e_4, _a;
        var selectableInstructor = this.getInstructorsByCategory(this.currentCategoryId);
        if (selectableInstructor === undefined) {
            return;
        ...
        try {
            for (var selectableInstructor_2 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](selectableInstructor), selectableInstructor_2_1 = selectableInstructor_2.next(); !selectableInstructor_2_1.done; selectableInstructor_2_1 = selectableInstructor_2.next()) {
                var element = selectableInstructor_2_1.value;
            ...
            try {
                if (selectableInstructor_2_1 && !selectableInstructor_2_1.done && (_a = selectableInstructor_2.return)) _a.call(selectableInstructor_2);
            }
            finally { if (e_4) throw e_4.error; }
        }
    };
    ManageClassroomInstructorsComponent.prototype.updateSelectedInstructors = function () {
    ...
    ManageClassroomInstructorsComponent.prototype.makeString = function (length) {
        var result = '';
    ...
    ManageClassroomInstructorsComponent.prototype.makeId = function (length) {
        var result = '';
    ...
    ManageClassroomInstructorsComponent.prototype.snackBarCreator = function (message) {
        this.snackBar.open(message, 'Close', {
            duration: 1000,
        });
    };
    ManageClassroomInstructorsComponent.ctorParameters = function () { return [
    ...
    return ManageClassroomInstructorsComponent;
}());
...
var ManageClassroomStudentsComponent = /** @class */ (function () {
    function ManageClassroomStudentsComponent(chosenStudents, snackBar, apiManagerService) {
    ...
    ManageClassroomStudentsComponent_1 = ManageClassroomStudentsComponent;
    ManageClassroomStudentsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.chosenStudents.currentList.subscribe(function (updatedChosenStudentList) { return _this.onStudentChosenChanged(updatedChosenStudentList); });
        this.onInitUpdateExistingStudentsToChosenStudentsService();
        this.getDataFromApiListenerAndPoster();
    };
    ManageClassroomStudentsComponent.prototype.getDataFromApiListenerAndPoster = function () {
        var _this = this;
        var api = this.apiManagerService.getManageClassroomData;
        var studentClassroomManagementGetData = new _Modals_StudentClassroomManagement_StudentClassroomManagementGetDataModal__WEBPACK_IMPORTED_MODULE_5__["StudentClassroomManagementGetDataModal"]('1', '1');
        ...
        this.apiCallSubscription = this.apiManagerService.onCallbackReceived.subscribe(function (callback) {
            if (callback.topic === (ManageClassroomStudentsComponent_1.name + '#GET')) {
                _this.getDataFromApiReceived(callback.data);
            }
    ...
    ManageClassroomStudentsComponent.prototype.getDataFromApiReceived = function (data) {
        var e_1, _a, e_2, _b, e_3, _c;
        try {
            for (var _d = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](data.response.result[0].result), _e = _d.next(); !_e.done; _e = _d.next()) {
                var row = _e.value;
        ...
        try {
            for (var _f = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](data.response.result[1].result), _g = _f.next(); !_g.done; _g = _f.next()) {
                var row = _g.value;
                var indexOfParentCategoryGroup = this.getIndexOfCategoryGroupByCategoryGroupId(row.organizational_category_group_id, this.categoryGroups);
        ...
        try {
            for (var _h = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](data.response.result[2].result), _j = _h.next(); !_j.done; _j = _h.next()) {
                var row = _j.value;
    ...
    ManageClassroomStudentsComponent.prototype.getIndexOfCategoryGroupByCategoryGroupId = function (searchElement, categoryGroups) {
        var e_4, _a;
        var index = -1;
        try {
            for (var categoryGroups_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](categoryGroups), categoryGroups_1_1 = categoryGroups_1.next(); !categoryGroups_1_1.done; categoryGroups_1_1 = categoryGroups_1.next()) {
                var categoryGroup = categoryGroups_1_1.value;
                index += 1;
            ...
            try {
                if (categoryGroups_1_1 && !categoryGroups_1_1.done && (_a = categoryGroups_1.return)) _a.call(categoryGroups_1);
            }
            finally { if (e_4) throw e_4.error; }
        }
        return -1;
    };
    ManageClassroomStudentsComponent.prototype.onStudentChosenChanged = function (updatedChosenStudentList) {
        this.selectedStudentIdsList = updatedChosenStudentList;
    };
    ManageClassroomStudentsComponent.prototype.selectCategory = function (categoryId) {
        var _this = this;
        this.currentCategoryId = categoryId;
    ...
    ManageClassroomStudentsComponent.prototype.getStudentsByCategory = function (categoryId) {
        var e_5, _a, e_6, _b;
        var selectableStudent = [];
        if (categoryId === '-2') {
            this.snackBarCreator('Choose a category first.');
            return;
        }
        if (categoryId === '-1') {
            try {
                ...
                for (var _c = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.availableStudents), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var student = _d.value;
        ...
        try {
            for (var _e = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.availableStudents), _f = _e.next(); !_f.done; _f = _e.next()) {
                var student = _f.value;
    ...
    ManageClassroomStudentsComponent.prototype.onInitUpdateExistingStudentsToChosenStudentsService = function () {
        var e_7, _a;
        // This means get all students across all categories
        var allStudents = this.getStudentsByCategory('-1');
        try {
            for (var allStudents_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](allStudents), allStudents_1_1 = allStudents_1.next(); !allStudents_1_1.done; allStudents_1_1 = allStudents_1.next()) {
                var student = allStudents_1_1.value;
                if (student.selected) {
            ...
            try {
                if (allStudents_1_1 && !allStudents_1_1.done && (_a = allStudents_1.return)) _a.call(allStudents_1);
            }
            finally { if (e_7) throw e_7.error; }
        }
    };
    ManageClassroomStudentsComponent.prototype.selectAllStudentsOfCurrentCategoryId = function () {
        var e_8, _a;
        var selectableStudent = this.getStudentsByCategory(this.currentCategoryId);
        if (selectableStudent === undefined) {
            return;
        }
        try {
            for (var selectableStudent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](selectableStudent), selectableStudent_1_1 = selectableStudent_1.next(); !selectableStudent_1_1.done; selectableStudent_1_1 = selectableStudent_1.next()) {
                var element = selectableStudent_1_1.value;
            ...
            try {
                if (selectableStudent_1_1 && !selectableStudent_1_1.done && (_a = selectableStudent_1.return)) _a.call(selectableStudent_1);
            }
            finally { if (e_8) throw e_8.error; }
        }
    };
    ManageClassroomStudentsComponent.prototype.unselectStudentsOfCurrentGroupId = function () {
        var e_9, _a;
        var selectableStudent = this.getStudentsByCategory(this.currentCategoryId);
        if (selectableStudent === undefined) {
            return;
        ...
        try {
            for (var selectableStudent_2 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](selectableStudent), selectableStudent_2_1 = selectableStudent_2.next(); !selectableStudent_2_1.done; selectableStudent_2_1 = selectableStudent_2.next()) {
                var element = selectableStudent_2_1.value;
            ...
            try {
                if (selectableStudent_2_1 && !selectableStudent_2_1.done && (_a = selectableStudent_2.return)) _a.call(selectableStudent_2);
            }
            finally { if (e_9) throw e_9.error; }
        }
    };
    ManageClassroomStudentsComponent.prototype.updateSelectedStudents = function () {
    ...
    ManageClassroomStudentsComponent.prototype.snackBarCreator = function (message) {
        this.snackBar.open(message, 'Close', {
            duration: 1000,
        });
    };
    var ManageClassroomStudentsComponent_1;
    ManageClassroomStudentsComponent.ctorParameters = function () { return [
        { type: _Shared_chosen_users_service__WEBPACK_IMPORTED_MODULE_3__["ChosenUsersService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] },
    ...
    return ManageClassroomStudentsComponent;
}());
...
var SelectUserElementComponent = /** @class */ (function () {
    function SelectUserElementComponent(chosenUsers) {
        this.chosenUsers = chosenUsers;
    }
    SelectUserElementComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.chosenUsers.currentList.subscribe(function (updatedChosenUserList) { return _this.chosenUsersChanged(updatedChosenUserList); });
    };
    SelectUserElementComponent.prototype.selectUser = function (isChecked) {
        if (!isChecked) {
    ...
    SelectUserElementComponent.prototype.chosenUsersChanged = function (updatedChosenUserList) {
        var _this = this;
        this.temp = '';
        this.selectedUserIdsList = updatedChosenUserList;
        this.selectedUserIdsList.forEach(function (value) { return _this.temp += '|' + value; });
        this.isChecked = this.selectedUserIdsList.indexOf(this.userId) !== -1;
    };
    SelectUserElementComponent.ctorParameters = function () { return [
    ...
    return SelectUserElementComponent;
}());
...
var MainComponent = /** @class */ (function () {
    function MainComponent(snackBar) {
        this.snackBar = snackBar;
        // Sign In Step ?
    ...
    MainComponent.prototype.onPostEnterListener = function (postId) {
    ...
    MainComponent.prototype.OnPostExitListener = function () {
    ...
    MainComponent.prototype.onWantToQuestion = function () {
        // Toggling currentView
    ...
    MainComponent.prototype.OnGotoAllPosts = function () {
        if (this.currentView !== 'POSTS') {
            this.currentView = 'POSTS';
        }
    };
    // utility functions
    MainComponent.prototype.snackBarCreator = function (message) {
        this.snackBar.open(message, 'Close', {
            duration: 1000,
        });
    };
    MainComponent.prototype.onSuccessfullySignedIn = function () {
        this.isSignedIn = true;
    };
    MainComponent.prototype.createNewClass = function () {
    ...
    MainComponent.prototype.enterClass = function (classId) {
        if (this.canChangeScreen() === false) {
            return;
        }
        this.snackBarCreator('Entering Class ' + classId);
    };
    MainComponent.prototype.gotoScreenAddStudentsToClassroom = function () {
        if (this.canChangeScreen() === false) {
            return;
        }
        this.currentView = 'MANAGE_CLASSROOM_STUDENTS';
    };
    MainComponent.prototype.gotoManageStudentsOfCurrentClassroom = function () {
        if (this.canChangeScreen() === false) {
            return;
        }
        this.currentView = 'MANAGE_CLASSROOM_STUDENTS';
    };
    MainComponent.prototype.gotoManageInstructorsOfCurrentChosenClassroom = function () {
        if (this.canChangeScreen() === false) {
            return;
        }
        this.currentView = 'MANAGE_CLASSROOM_INSTRUCTORS';
    };
    MainComponent.prototype.canChangeScreen = function () {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.screensWhereYouCannotLeaveWithoutConfirmingChanges), _c = _b.next(); !_c.done; _c = _b.next()) {
                var screen_1 = _c.value;
                if (this.currentView === screen_1) {
                    this.snackBarCreator('Finalize before switching screens.');
                    return false;
                }
            }
...
var PostQuestionComponent = /** @class */ (function () {
    function PostQuestionComponent(snackBar) {
        this.snackBar = snackBar;
    ...
    PostQuestionComponent.prototype.onSelectionChangedAnonymityLevel = function ($event) {
        this.selectedAnonymityScopeId = $event.value;
        this.showSnackbarMessage('You will be posting as ' + this.getAnonymityScopeNameFromChosenAnonymityScopeId());
    };
    PostQuestionComponent.prototype.onSelectionChangedGroup = function ($event) {
    ...
    PostQuestionComponent.prototype.onTagChangedGroup = function ($event) {
        this.selectedTagId = $event.value;
        console.log($event.value);
        this.showSnackbarMessage('Changed Tag to ' + this.getTagNameFromChosenTagId());
    };
    PostQuestionComponent.prototype.postQuestion = function () {
    ...
    PostQuestionComponent.prototype.saveDraft = function () {
    ...
    // Utility functions
    PostQuestionComponent.prototype.getClassNameFromChosenClassId = function () {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.classes), _c = _b.next(); !_c.done; _c = _b.next()) {
                var aClass = _c.value;
    ...
    PostQuestionComponent.prototype.getTagNameFromChosenTagId = function () {
        var e_2, _a, e_3, _b;
        try {
            for (var _c = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.classes), _d = _c.next(); !_d.done; _d = _c.next()) {
                var aClass = _d.value;
                try {
                    for (var _e = (e_3 = void 0, tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](aClass.tags)), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var tag = _f.value;
    ...
    PostQuestionComponent.prototype.getAnonymityScopeNameFromChosenAnonymityScopeId = function () {
        var e_4, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.anonymityScope), _c = _b.next(); !_c.done; _c = _b.next()) {
                var anonymityScope = _c.value;
    ...
    PostQuestionComponent.prototype.getTagsOfAChosenClass = function () {
        var e_5, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.classes), _c = _b.next(); !_c.done; _c = _b.next()) {
                var aClass = _c.value;
    ...
    PostQuestionComponent.prototype.showSnackbarMessage = function (message) {
        this.snackBar.open(message, 'Close', {
            duration: 2000,
        });
    };
...
var SearchAndFiltersComponent = /** @class */ (function () {
    function SearchAndFiltersComponent() {
    ...
    SearchAndFiltersComponent.prototype.emitAskAQuestionEvent = function () {
    ...
    return SearchAndFiltersComponent;
}());
...
var SingleQuestionWithAnswersComponent = /** @class */ (function () {
    function SingleQuestionWithAnswersComponent(snackBar) {
        this.snackBar = snackBar;
        this.selectedAnonymityScopeId = 1;
        this.defaultAnonymityScope = '1';
        this.anonymityScope = [
    ...
    SingleQuestionWithAnswersComponent.prototype.onSelectionChangedAnonymityLevel = function ($event) {
        this.selectedAnonymityScopeId = $event.value;
        this.showSnackbarMessage('You will be posting as ' + this.getAnonymityScopeNameFromChosenAnonymityScopeId());
    };
    SingleQuestionWithAnswersComponent.prototype.getAnonymityScopeNameFromChosenAnonymityScopeId = function () {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.anonymityScope), _c = _b.next(); !_c.done; _c = _b.next()) {
                var anonymityScope = _c.value;
    ...
    SingleQuestionWithAnswersComponent.prototype.showSnackbarMessage = function (message) {
        this.snackBar.open(message, 'Close', {
            duration: 2000,
        });
    };
    SingleQuestionWithAnswersComponent.prototype.postAnswer = function () {
        this.showSnackbarMessage('PSEUDO POST QUESTION' + '\n' +
            'HTML Content: ' + this.htmlContent + '\n' +
            'Anonymity Level: ' + this.getAnonymityScopeNameFromChosenAnonymityScopeId() + '\n');
    };
    SingleQuestionWithAnswersComponent.prototype.toggleShowAnswerBar = function () {
        this.showAnswerBar = !this.showAnswerBar;
    };
    SingleQuestionWithAnswersComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return SingleQuestionWithAnswersComponent;
}());
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(snackBar) {
        this.snackBar = snackBar;
    ...
    SidebarComponent.prototype.openSnackBar = function (groupName) {
        this.snackBar.open('Entering ' + groupName, 'Close', {
            duration: 2000,
        });
    };
    SidebarComponent.prototype.emitWantToCreateANewClass = function () {
        this.WantToCreateANewClass.emit();
    };
    SidebarComponent.prototype.emitEnterClass = function (classId) {
...
var ShinyTextComponent = /** @class */ (function () {
    function ShinyTextComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
